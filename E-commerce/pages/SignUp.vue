            ...
            <div class="signup-container">
                <div>
                    <nuxtLink class="header-logo-link" to="/">    
                        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="40" viewBox="0 0 115 30">
                ...
                <div class="sign-up-section-description">
                    <h1>
                        ورود | ثبت‌نام
                    </h1>
                    <p>
                ...
                <div class="abc">
                    <p>
                        ورود شما به معنای پذیرش <a target="_blank" href="https://www.digikala.com/page/terms/">شرایط دیجی‌کالا</a> و <a target="_blank" href="https://www.digikala.com/page/privacy/">قوانین حریم‌خصوصی</a> است
                    </p>
                </div>
            </div>
        </div>
