<template>
    <div>
        <div class="shipment-page-wrapper">
            <div class="shipment-page-container">
                <div class="how-to-send-section">
                    <Shipping />
                </div>
                <div class="cart-description-section">
                    <div class="shipment-price-section">
